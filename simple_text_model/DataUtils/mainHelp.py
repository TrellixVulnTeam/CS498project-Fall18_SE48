...
def preprocessing(config):
    ...
    # ---------------------------------
    # 3.create the alphabet (what is createAlphabet)
    alphabet = None
    ...
    # ---------------------------------
    # 5.create iterator (what is  createIterator)
    ...
    # 6. create and save iterator dictionary
...
def load_data(config):
    ...
    if (config.train is True) and (config.process is True):
        ...
        # 1.delete pkl_directory
        if os.path.exists(config.pkl_directory):
            shutil.rmtree(config.pkl_directory)
        # 2.create pkl_directory
