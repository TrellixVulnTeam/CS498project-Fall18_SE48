...
class Train(object):
    ...
    def _dynamic_lr(self, config, epoch, new_lr):
        ...
        :return:
        """
        if config.use_lr_decay is True \
                and epoch > config.max_patience \
                and (epoch - 1) % config.max_patience == 0 \
                and new_lr > config.min_lrate:
    ...
    def train(self):
        ...
        for epoch in range(1, epochs + 1):
            ...
            # 3.prepare: 1.shuffle, 2.set train mode, 3.set optimizer
